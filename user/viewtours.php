...
if(isset($_REQUEST["search"])){
	...
	$sql = "select * FROM tourtbl where ttype = '" . $ttype . "'";
...
<html lang="en">
    <head>
    <title>Tours And Travels Managemnt - Tour Booking</title>
         <link
      rel="stylesheet"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="fa fa-users"></i>&nbsp &nbsp Search Tours</h4><hr>
                                </div>
                                <div class="card-body">
								<form method="POST">
...
<select name="ttype">
    ...
    <option value="ONE DAY PICNIC">ONE DAY PICNIC</option>
    <option value="OTHERS">OTHERS</option>
		...
		<input type="Submit" name="search" value="search tours"class="btn btn-success btn-fill pull-left"> 
...
<td>
    <a href="tourbooking.php?tid=<?php echo $row['tid'];?>">
        Booking 
    </a>
</td>
</tr>
