 <?php
  ...
  if (isset($_REQUEST['save']))
  {
    ...
    $message=$_REQUEST['message'];
          ...
          $sql="INSERT INTO feedbacktbl  (fname, fdt, fdtls) VALUES ('$name', '$fdt' , '$message' )";
...
<script type="text/javascript">alert('Your mesasge is accepted'); window.location = 'feedback.php';</script>
    <?php
  }
  else
  ...
  {
    ?>
    <script type="text/javascript">alert('Message is not accepted'); window.location.href="feedback.php"</script>
    <?php
        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo">User's Dashboard</a>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="fa fa-users"></i>&nbsp &nbsp Feedback</h4><hr>
                                </div>
                                <div class="card-body">
								<form method="POST">
                                           ...
                                           <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <label>Message</label>
                                                    <br>
                                                    <textarea name="message" class="input" rows="4" cols="30"></textarea>
                                                </div>
                                            </div>
                                           </div>
