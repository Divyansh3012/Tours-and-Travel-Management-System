...
// }
	// $uid = $_SESSION['uid'];
	$uid = 1;
	$sql = "select * FROM bookingtbl where uid ='". $uid . "'";
        ...
        <div class="main-panel">
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class=" container-fluid  ">
                    <a class="navbar-brand" href="#pablo">My Bookings </a>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="fa fa-building"></i>&nbsp &nbsp My Bookings</h4><hr>
                                </div>
                                <div class="card-body">
