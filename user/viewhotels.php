<?php
	require "connect.php";
	     ...
	     if (isset($_REQUEST["find"]))
	     {
	     	...
	     	$city = $_POST["City"];
	$sql="select * FROM hoteltbl where hcity = '" . $city . "'";
...
<head>
    ...
    <div class="wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class="fa fa-building"></i>&nbsp &nbsp Search Hotels</h4><hr>
                                </div>
                                <div class="card-body">
								<form method="POST">
		...
		<input type="submit" name="find" value="search" class="btn btn-success btn-fill pull-left"> 
...
<td><img src="<?php echo $row['hphoto'];?>" height="50" />

</td>
<td>
    <a href="hotelbooking.php?hid=<?php echo $row['hid'];?>">
        Booking 
    </a>
  </td>
