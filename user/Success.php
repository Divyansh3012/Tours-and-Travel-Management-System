...
$price = $_SESSION['totalfare'];
$ttype = $_SESSION['type'];

if($ttype == "Hotel Booking")
    $id1 = $_SESSION["hotelid"];
else if ($ttype == "Tour Booking")
    $id1 = $_SESSION["tourid"];
...
$sql="insert into bookingtbl (bid, Bdate, uid, Tickettype, TotalAmount, Bstatus, vid) values ('$bookingno', '$bdate' , '$uid', '$ttype', '$price', 'PAID', '$id1')"; 
...
$bdate = date('Y-m-d'); // current date for payment

$sql2="insert into payment(Pdate, Bookingid, Uid, Amount, Pstatus) values ('$bdate' , '$bookingno','$uid', '$price','PAID')"; 
...
<head>
  ...
  <title>Booking Confirmation Status</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"> <i class=""></i>&nbsp &nbsp Booking</h4><hr>
                                </div>
                                <div class="card-body">
  <label style="color:green;font-size: 18pt;">
