                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title"> <i class="fa fa-users"></i>  Manage Buses</h4><hr>
                                </div>
                                <br>

                                <div class="card-body table-full-width table-responsive">
                                    <a href="users_create.html" class="btn btn-success btn-sm btn-fill" style="margin-left: 5px;">Create Buses</a>
                                    <br><br>
...
<td>
	<a href ="manageBus.php?Bid_remove=<?php echo $row["Bid"]?>" class="btn btn-danger btn-sm btn-fill">delete</a>
</td>
</tr>
<?php
}
