...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2022 at 07:11 AM
...
INSERT INTO `bookingtbl` (`Bid`, `Bdate`, `uid`, `Tickettype`, `TotalAmount`, `Bstatus`, `vid`) VALUES
(0, '', 2, '', '', 'PAID', -1),
(1, '25/12/21', 1, 'Bus ticket', '2000', 'Active', 0),
(2, '26/12/21', 2, 'Train ticket', '1500', 'Cancel', 0),
(3, '27/12/21', 3, 'Tour ticket', '4000', 'Confirm', 0),
(4, '28/12/21', 4, 'Hotel ticket', '3000', 'Confirm', 0),
(3149, '0', 2, 'Tour Booking', '4000', 'PAID', -1),
(4682, '2022-04-15', 2, 'Train Booking', '7000', 'PAID', -1),
(8565, '2022-04-14', 2, 'Hotel Booking', '2400', 'PAID', 2),
(9486, '2022-04-12', 2, 'Bus Booking', '3000', 'PAID', -1),
(9565, '', 2, 'Hotel Booking', '2200', 'PAID', 1),
(15288, '2022-04-09', 2, 'Bus Booking', '6000', 'PAID', -1),
(17429, '2022-04-06', 2, 'Hotel Booking', '1200', 'PAID', -1);
...
INSERT INTO `hoteltbl` (`hid`, `hname`, `hemail`, `hpwd`, `hstar`, `haddress`, `hcity`, `hpin`, `hphoto`, `charges`) VALUES
(1, 'The Taj Mahal Palace', 'tajmahal@gmail.com', 'taj1212', '5', 'Apollo Bandar,Collaba,Mumbai,Maharashtra', 'Mumbai', '400001', 'C:\\xampp\\htdocs\\project\\hotel images\\h1.jpg', '1100.00'),
(2, 'The Oberoi Trident', 'oberoitrident@gmail.com', 'oberoi3434', '5 star', 'Collaba , Mumabai, Maharashtra', 'Mumbai', '99988', '', '1200.00'),
(3, 'The Landmark', 'landmark@gmail.coom', 'landmark0101', '5 star', 'Adajan, Surat, Gujarat', 'Surat', '390002', '', '1800.00'),
(4, 'HOTEL AIRPORT', 'airport@hotmail.com', '123456', '3', 'OPP. AIRPORT HARNI ROAD, VADODARA', 'VADODARA', '390022', '../hotelupload/hotel-building.jpg', '5000.00');
...
INSERT INTO `payment` (`Pid`, `Pdate`, `Bookingid`, `Uid`, `Amount`, `Pstatus`) VALUES
(1, '2021-12-25', 0, 1, '2000', 'Paid'),
(2, '2021-12-27', 0, 2, '3000', 'Draft'),
(3, '2021-12-27', 0, 3, '3500', 'Draft'),
(4, '2021-12-09', 0, 1, '400000', 'Active'),
(5, '2021-11-17', 0, 5, '500000', 'Active'),
(8, '2022-04-12', 9486, 2, '3000', 'PAID'),
(9, '2022-04-15', 4682, 2, '7000', 'PAID'),
(10, '2022-04-07', 17429, 2, '1200', 'PAID'),
(11, '2022-04-07', 9565, 2, '2200', 'PAID'),
(12, '2022-04-07', 8565, 2, '2400', 'PAID'),
(13, '2022-04-08', 3149, 2, '4000', 'PAID');
...
INSERT INTO `tourtbl` (`tid`, `tname`, `temail`, `tpwd`, `ttype`, `tdays`, `tnight`, `tcharges`, `tdetails`, `toid`) VALUES
(1, 'Patel Tours', 'patel@gmail.com', '3434', 'FAMILY TOUR', '5', '4', '9000', 'Here ,we have 5 days and 4 nights tour package , as per the schedule we will have conference on first day, on second we will have site visit and on third we have meeting with chief executive officer and on last we will have dinner and late night party.\r\nAnd on 5th day we will about to go back.', 0),
(2, 'Ganpat Tours', 'ganpat@gmail.com', 'ganpat3232', 'COUPLE TOUR', '3', '2', '4000', 'Here, we will have 3 days and 2 nights weekend trip, that serves you a fully enjoyable weekend \r\nOur venue will be CTM Circle Ahmedabad at 9pm,we will provide food packets in between the journey and also dinner, lunch and breakfast included.\r\nIn this tour we will have visit  at most visited places l', 0),
(3, 'Sainath Tours', 'sainath@gmail.com', 'sainath22', 'Tourism', '4', '3', '24000', 'Here, we will visit at Gir Forest, Gujarat \r\nOur venue will be at CTM Circle, Ahmedabad \r\nThis tour provides you with dinner and lunch at exact time and the food packets will be provided throughout the tour when needed.\r\nwe will have the jungle safari ,forest scene visit, jeep safari in jungle this ', 0);
